...
export default async function BikesPage() {
  ...
  const products = await payload.find({
    ...
    sort: '-publishedAt',
    // Narrow the SELECT to just the fields used below. This keeps the SQL
    // query small so Neon doesn't OOM on the lateral joins for array fields.
    select: {
      name: true,
      slug: true,
      brand: true,
      ...
      throttle: true,
      batteryWh: true,
      estimatedRealRangeMi: true,
      batteryRemovable: true,
      dualBatteryCapable: true,
      weightLbs: true,
      maxSystemWeightLbs: true,
      cargoCapacityLbs: true,
      foldable: true,
      fitsInElevator: true,
      drivetrainType: true,
      gearType: true,
      brakeType: true,
      cargoLayout: true,
      maxChildPassengers: true,
      hasSeatbelts: true,
      hasRainCover: true,
      rainCoverAvailable: true,
      integratedLights: true,
      gpsTracking: true,
      alarm: true,
      suspensionType: true,
      bestFor: true,
